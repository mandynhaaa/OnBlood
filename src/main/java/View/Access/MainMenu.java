...
public class MainMenu extends JFrame {
    ...
    public MainMenu(User user) {
        ...
        if ("Administrador".equals(userType)) {
            ...
            addButton("Configurações da Conta", e -> openAccountConfiguration());
    ...
    private void openAccountConfiguration() {
        AccountConfiguration configWindow = new AccountConfiguration(this.user);
